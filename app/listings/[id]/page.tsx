                  ...
                  {stats.moveSpeed !== undefined && (
                    <div className="bg-gradient-to-br from-cyan-50 to-cyan-100 rounded-lg p-4 border border-cyan-200">
                      <div className="flex items-center space-x-2 mb-1">
                        ...
                        <span className="text-xs font-medium text-cyan-700 uppercase">
                          Move Speed
                        </span>
                      </div>
                ...
                <div className="mt-8">
                  <div className="mb-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                    <p className="text-blue-800 text-sm">
                      💡 <strong>Tip:</strong> Check the bell icon 🔔 in the
                      header for bid notifications!
                    </p>
                  </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <span>
                        {submittingOffer ? "Submitting..." : "Place Bid"}
                      </span>
                    </button>
                  </form>
                </div>
              ...
              {listing.isActive && (
                <div className="mt-8 p-4 bg-green-50 border border-green-200 rounded-lg">
                  <p className="text-green-800 text-sm">
                    ✓ This listing is active and accepting bids
                  </p>
                </div>
              )}
